...
/**
 * An extention of pizza to make the pizza specifically hand-tossed. 
 * Stores hand-tossed pizza information and has a toString to organize the
 * information.
 * 
 * @author Kayla-Ann Hurdle
 * 
 */
public class HandTossed extends Pizza {
	private String name;
	 ...
	 */
	public HandTossed (String[] toppings, double price, boolean extraCheese, String sauce, String size, String name) {
	...
	public String toString() {
		...
		pizzaInformation += this.name + "/" + getSize() + "/hand-tossed/";
